  ...
  return (
    <MainContainer>
      ...
      <Form onSubmit={handleClick}>
        ...
        <Input id="idade" type="text" value={form.name} onChange={onChange} />

        <label htmlFor="email">E-mail:</label>
        <Input id="email" type="text" value={form.name} onChange={onChange} />
        <label htmlFor="profissao">Profissão:</label>
        <Input id="profissao" required value={form.name} onChange={onChange} />
